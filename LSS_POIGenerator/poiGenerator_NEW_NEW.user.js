...
(function() {
    ...
    function addToForm() {
        ...
        let jsString = $("#buildings script").html();
    ...
    async function start()
    {
        ...
        $.each(pois.elements, (e, t) => {
            //If POI doesn't exist, create
            if(!mappedPois[poiName] || !mappedPois[poiName].includes(t.lat +","+t.lon) || (t.center.lat && !mappedPois[poiName].includes(t.center.lat +","+t.center.lon))) {
                setTimeout(() => {
