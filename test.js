!function (t, e, n, o, r) {
    function s(t, e, n, o) {
        var r = e[0] % H, s = e[1] % F, i = e[2] % z, a = function (t, e, n, r) {
            var s = r * o, i = r * o, a = -e % n * s, c = -Math.floor(e / n) * i, u = s * n, h = i * n;
    ...
    function l() {
        if (it) if (st && st.drawingID == st.myID) {
    ...
    function g() {
        ...
        var e = !1;
        if (!t) {
            var n = o.getItem("lastAd"), s = new Date;
            if (null === n || n === r || "undefined" === n) e = !0; else {
    ...
    function w() {
        grecaptcha.ready(function () {
            grecaptcha.execute("6LeFbcgUAAAAAHQcfuuaFjakmubtKjKCmYM5cbIJ", {action: "homepage"}).then(function (t) {
                dt = t, k()
            })
        })
    }
    ...
    function x() {
        ...
        var o = "", r = t.location.href.split("?");
        r.length > 1 && (o = r[1]);
        var s = n("#loginLanguage").val();
        return {name: e[0], code: e[1], avatar: loginAvatarData, join: o, language: s, createPrivate: pt}
    }

    function C(t, e) {
        at.playSound("playerJoin"), it = io(t, {query: {token: dt}}), it.on("connect", function () {
            it.on("disconnect", function () {
                ...
                var e = st.players.get(t.id), n = st.players.get(st.myID), o = e.id == st.drawingID || e.guessedWord;
                n.id != st.drawingID && !n.guessedWord && o || st.chatAddMsg(e, b(t.message), o ? "#7dad3f" : "#000")
                ...
                st && st.chatAddMsg(null, "Server will restart in about " + t + " seconds...", _)
            }), it.on("lobbyVotekickCurrent", function (t) {
                if (st) {
                    var e = st.players.get(t[0]), n = st.players.get(t[1]);
                    st.chatAddMsg(null, "'" + e.name + "' is voting to kick '" + n.name + "' (" + t[2] + "/" + t[3] + ")", _)
                }
            }), it.on("lobbyConnected", function (t) {
                if (ut.clear(), M(""), st = new tt(t), st.inGame) {
                ...
                var e = st.players.get(t);
                st.setPlayerGuessed(e), st.chatAddMsg(null, e.name + " guessed the word!", N), t == st.myID && st.chatDisable(), at.playSound("playerGuessed")
            }), it.on("lobbyGuessClose", function (t) {
                st.chatAddMsg(null, "'" + t + "' is close!", _)
                ...
                var e = st.players.get(t);
                st.setPlayerOwner(e), st.chatAddMsg(null, e.name + " is the owner now!", N)
            }), it.on("lobbyRound", function (t) {
                st.round = t, st.updateRound(), L({mode: "text", text: "Round " + (st.round + 1)})
            }), it.on("lobbyChooseWord", function (t) {
                if (t.id == st.myID) L({mode: "choosewords", text: "Choose a word", words: t.words}); else {
                    L({mode: "text", text: st.players.get(t.id).name + " is choosing a word!"})
                }
            }), it.on("lobbyReveal", function (t) {
                A(), st.chatEnable(), st.chatAddMsg(null, "The word was '" + t.word + "'", N);
                for (var e = [], n = !0, o = 0; o < t.scores.length / 2; o++) {
                    var r = t.scores[2 * o], s = t.scores[2 * o + 1], i = st.players.get(r);
                    if (i) {
                        i.guessedWord && (n = !1);
                        var a = s - i.score;
                ...
                var e = st.players.get(t[0]), n = st.players.get(t[1]), o = t[2];
                e && st.playerRate(e, o), n && (o > 0 ? n.thumbsUp++ : n.thumbsDown++)
            }), it.on("lobbyCurrentWord", function (t) {
                st.players.get(st.myID).guessedWord || M(t)
    ...
    function L(t) {
        ...
        lt = !0;
        var e = n("#overlay");
        e.show(), e.animate({opacity: "1"}, q), R(t)
    }

    function R(t) {
        var e = n("#overlay"), o = e.find(".content");
        ...
        var c = e.find(".revealReason"), u = o.find(".revealContainer");
        if ("reveal" == t.mode) {
            ...
            for (var i = 0; i < t.players.length; i++) {
                var h = t.players[i], l = n("<div class='player'></div>"), p = n("<div class='name'></div>");
                p.text(h.name);
        ...
        if ("endgame" == t.mode) {
            ...
            var y = n(".gameEndContainerPlayersBest"), m = n(".gameEndContainerPlayers");
            y.empty(), m.empty();
            for (var i = 0; i < t.players.length; i++) {
                var h = t.players[i], l = B(n("#gameEndPlayerDummy"));
        ...
        o.show(), o.animate({bottom: "0%"}, q, "easeInOutBack", function () {
            t.onshow && t.onshow()
        })
    }
    ...
    function U() {
        if (lt) {
            var t = n("#overlay"), e = t.find(".content"), o = ht.pop();
            o ? e.animate({bottom: "100%"}, W, "easeInOutBack", function () {
                R(o)
            }) : (lt = !1, t.animate({opacity: "0"}, W, function () {
                t.hide()
            }), e.animate({bottom: "100%"}, W, "easeInOutBack", function () {
                e.hide()
            }))
        }
    }
    ...
    !function (t, e) {
        ...
        return function (t) {
            ...
            function o(t, e) {
                ...
                var n, o = i(t), a = o.source, l = o.id, p = o.path, f = h[l] && p in h[l].nsps;
            ...
            }, i = n(1), a = n(7), c = n(17), u = n(3)("socket.io-client");
            t.exports = e = o;
            var h = e.managers = {};
            ...
            (function (e) {
                ...
                function o(t, n) {
                    ...
                    var i = -1 !== o.host.indexOf(":"), a = i ? "[" + o.host + "]" : o.host;
                    return o.id = o.protocol + "://" + a + ":" + o.port, o.href = o.protocol + "://" + a + (n && n.port === o.port ? "" : ":" + o.port), o
                }

                var r = n(2), s = n(3)("socket.io-client:url");
                t.exports = o
            }).call(e, function () {
                return this
            }())
            ...
            function a(t) {
                var n, o;
                for (n = 0, o = e.skips.length; n < o; n++) if (e.skips[n].test(t)) return !1;
                for (n = 0, o = e.names.length; n < o; n++) if (e.names[n].test(t)) return !0;
                return !1
            }
            ...
            var i = 1e3, a = 60 * i, c = 60 * a, u = 24 * c, h = 365.25 * u;
            ...
            function s(t, e) {
                function n(t) {
                    var n = d.deconstructPacket(t), o = r(n.packet), s = n.buffers;
                    s.unshift(o), e(s)
                }
            ...
            var l = n(8)("socket.io-parser"), p = n(11), f = n(13), d = n(14), y = n(16);
            e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = o, e.Decoder = i, o.prototype.encode = function (t, n) {
                if (l("encoding packet %j", t), e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type) s(t, n); else {
                    n([r(t)])
                }
                ...
                (function () {
                    function s(t, e) {
                        function n(t) {
                            if (n[t] !== m) return n[t];
                            var s;
                            if ("bug-string-char-index" == t) s = "a" != "a"[0]; else if ("json" == t) s = n("json-stringify") && n("json-parse"); else {
                                var i, a = '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';
                                if ("json-stringify" == t) {
                                    var u = e.stringify, h = "function" == typeof u && b;
                                    if (h) {
                                        (i = function () {
                                            return 1
                                        }).toJSON = i;
                                        try {
                                            h = "0" === u(0) && "0" === u(new o) && '""' == u(new r) && u(v) === m && u(m) === m && u() === m && "1" === u(i) && "[1]" == u([i]) && "[null]" == u([m]) && "null" == u(null) && "[null,null,null]" == u([m, v, null]) && u({a: [i, !0, !1, null, "\0\b\n\f\r\t"]}) == a && "1" === u(null, i) && "[\n 1,\n 2\n]" == u([1, 2], null, 1) && '"-271821-04-20T00:00:00.000Z"' == u(new c(-864e13)) && '"+275760-09-13T00:00:00.000Z"' == u(new c(864e13)) && '"-000001-01-01T00:00:00.000Z"' == u(new c(-621987552e5)) && '"1969-12-31T23:59:59.999Z"' == u(new c(-1))
                                        } catch (t) {
                                            h = !1
                                        }
                                    }
                        ...
                        var o = t.Number || u.Number, r = t.String || u.String, i = t.Object || u.Object,
                            c = t.Date || u.Date, h = t.SyntaxError || u.SyntaxError, l = t.TypeError || u.TypeError,
                            p = t.Math || u.Math, f = t.JSON || u.JSON;
                        "object" == typeof f && f && (e.stringify = f.stringify, e.parse = f.parse);
                        var d, y, m, g = i.prototype, v = g.toString, b = new c(-0xc782b5b800cec);
                        try {
                        ...
                        if (!n("json")) {
                            var w = "[object Function]", k = "[object Number]", x = "[object String]",
                                C = "[object Array]", A = n("bug-string-char-index");
                            if (!b) var D = p.floor, S = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
                                P = function (t, e) {
                            ...
                            if ((d = g.hasOwnProperty) || (d = function (t) {
                                ...
                                var E = {92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t"},
                                    M = function (t, e) {
                                        ...
                                        if ("object" == typeof a && a) if ("[object Date]" != (c = v.call(a)) || d.call(a, "toJSON")) "function" == typeof a.toJSON && (c != k && c != x && c != C || d.call(a, "toJSON")) && (a = a.toJSON(t)); else if (a > -1 / 0 && a < 1 / 0) {
                                            if (P) {
                                        ...
                                        if (c == x) return T("" + a);
                                        if ("object" == typeof a) {
                                            for (L = i.length; L--;) if (i[L] === a) throw l();
                                ...
                                e.stringify = function (t, e, n) {
                                    var o, r, s, i;
                                    if (a[typeof e] && e) if ((i = v.call(e)) == w) r = e; else if (i == C) {
                                        s = {};
                                        for (var c, u = 0, h = e.length; u < h; c = e[u++], ((i = v.call(c)) == x || i == k) && (s[c] = 1)) ;
                                    }
                                    if (n) if ((i = v.call(n)) == k) {
                            ...
                            if (!n("json-parse")) {
                                var I, L, R = r.fromCharCode, U = {
                                    ...
                                    for (var t, e, n, o, r, s = L, i = s.length; I < i;) switch (r = s.charCodeAt(I)) {
                                        ...
                                        case 34:
                                            for (t = "@", I++; I < i;) if ((r = s.charCodeAt(I)) < 32) N(); else if (92 == r) switch (r = s.charCodeAt(++I)) {
                                                case 92:
                                                case 34:
                                                case 47:
                                                case 98:
                                    ...
                                    if ("$" == t && N(), "string" == typeof t) {
                                        ...
                                        if ("[" == t) {
                                            for (e = []; "]" != (t = _()); n || (n = !0)) n && ("," == t ? "]" == (t = _()) && N() : N()), "," == t && N(), e.push(O(t));
                                            return e
                                        }
                                        if ("{" == t) {
                                            for (e = {}; "}" != (t = _()); n || (n = !0)) n && ("," == t ? "}" == (t = _()) && N() : N()), "," != t && "string" == typeof t && "@" == (A ? t.charAt(0) : t[0]) && ":" == _() || N(), e[t.slice(1)] = O(_());
                                            return e
                                        }
                                        N()
                                    }
                                    ...
                                    var o, r = t[e];
                                    if ("object" == typeof r && r) if (v.call(r) == C) for (o = r.length; o--;) j(r, o, n); else y(r, function (t) {
                                        j(r, t, n)
                                    });
                                    return n.call(t, e, r)
                                };
                    ...
                    var i = "function" == typeof r && r.amd, a = {
                            function: !0, object: !0
                        }, c = a[typeof n] && n && !n.nodeType && n, u = a[typeof t] && t || this,
                        h = c && a[typeof e] && e && !e.nodeType && "object" == typeof o && o;
                    if (!h || h.global !== h && h.window !== h && h.self !== h || (u = h), c && !i) s(u, c); else {
                        var l = u.JSON, p = u.JSON3, f = !1, d = s(u, u.JSON3 = {
                            noConflict: function () {
            ...
            (function (t) {
                ...
                e.deconstructPacket = function (t) {
                    ...
                    var n = [], s = t.data, i = t;
                    return i.data = e(s), i.attachments = n.length, {packet: i, buffers: n}
                    ...
                    function s(e, c, u) {
                        ...
                        } else if (o(e)) for (var l = 0; l < e.length; l++) s(e[l], l, e); else if (e && "object" == typeof e && !r(e)) for (var p in e) s(e[p], p, e)
                    }
            ...
            var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                    ...
                    return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
                }, s = n(18), i = n(44), a = n(35), c = n(7), u = n(46), h = n(47), l = n(3)("socket.io-client:manager"),
                p = n(42), f = n(48), d = Object.prototype.hasOwnProperty;
            ...
            (function (e) {
                ...
                var s = n(21), i = n(35), a = n(3)("engine.io-client:socket"), c = n(42), u = n(27), h = n(2),
                    l = n(43), p = n(36);
                t.exports = o, o.priorWebsocketSuccess = !1, i(o.prototype), o.protocol = u.protocol, o.Socket = o, o.Transport = n(26), o.transports = n(21), o.parser = n(27), o.prototype.createTransport = function (t) {
                        ...
                        l || (a('probe transport "%s" opened', t), h.send([{
                            ...
                            if (!l) if ("pong" === e.type && "probe" === e.data) {
                                ...
                                o.priorWebsocketSuccess = "websocket" === h.name, a('pausing current transport "%s"', p.transport.name), p.transport.pause(function () {
                                    l || "closed" !== p.readyState && (a("changing transport and sending upgrade packet"), u(), p.setTransport(h), h.send([{type: "upgrade"}]), p.emit("upgrade", h), h = null, p.upgrading = !1, p.flush())
                                })
                            } else {
                    ...
                    var h = this.createTransport(t, {probe: 1}), l = !1, p = this;
            ...
            (function (t) {
                ...
                var r = n(22), s = n(24), i = n(39), a = n(40);
            ...
            (function (e) {
                var o = n(23);
                t.exports = function (t) {
                    var n = t.xdomain, r = t.xscheme, s = t.enablesXDR;
                    try {
            ...
            (function (e) {
                ...
                function r(t) {
                    if (c.call(this, t), this.requestTimeout = t.requestTimeout, e.location) {
                        var n = "https:" === location.protocol, o = location.port;
                ...
                var a = n(22), c = n(25), u = n(35), h = n(37), l = n(3)("engine.io-client:polling-xhr");
                t.exports = r, t.exports.Request = s, h(r, c), r.prototype.supportsBinary = !0, r.prototype.request = function (t) {
                    ...
                    var n = "string" != typeof t && void 0 !== t,
                        o = this.request({method: "POST", data: t, isBinary: n}), r = this;
            ...
            var r = n(26), s = n(36), i = n(27), a = n(37), c = n(38), u = n(3)("engine.io-client:polling");
            t.exports = o;
            var h = function () {
                return null != new (n(22))({xdomain: !1}).responseType
            }();
            ...
            (function (t) {
                ...
                function r(t, n, o) {
                    ...
                    var r = t.data, s = new Uint8Array(r), i = new Uint8Array(1 + r.byteLength);
                    i[0] = v[t.type];
                ...
                var u, h = n(28), l = n(29), p = n(30), f = n(31), d = n(32);
                ...
                var v = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, b = h(v),
                    w = {type: "error", data: "parser error"}, k = n(34);
                e.encodePacket = function (e, n, s, a) {
                    ...
                    var s = new Uint8Array(t), r = s[0], i = p(t, 1);
                    return k && "blob" === n && (i = new k([i])), {type: b[r], data: i}
                }, e.decodeBase64Packet = function (t, e) {
                    var n = b[t.charAt(0)];
                    if (!u) return {type: n, data: {base64: !0, data: t.substr(1)}};
                    var o = u.decode(t.substr(1));
                    return "blob" === e && k && (o = new k([o])), {type: n, data: o}
            ...
            (function (e) {
                function o(t) {
                    function n(t) {
                        ...
                        if (r(t)) {
                            for (var o = 0; o < t.length; o++) if (n(t[o])) return !0
                        } else if (t && "object" == typeof t) {
                            t.toJSON && "function" == typeof t.toJSON && (t = t.toJSON());
                            for (var s in t) if (Object.prototype.hasOwnProperty.call(t, s) && n(t[s])) return !0
                        }
                        return !1
                    }
            ...
            (function (t, r) {
                !function (s) {
                    ...
                    var y, m, g, v = String.fromCharCode, b = {version: "1.0.0", encode: h, decode: f};
                    void 0 !== (o = function () {
                        return b
            ...
            !function () {
                ...
                e.encode = function (e) {
                    var n, o = new Uint8Array(e), r = o.length, s = "";
                    ...
                    var e, o, r, s, i, a = .75 * t.length, c = t.length, u = 0;
            ...
            (function (e) {
                ...
                var s = e.BlobBuilder || e.WebKitBlobBuilder || e.MSBlobBuilder || e.MozBlobBuilder, i = function () {
                    try {
            ...
            (function (n) {
                ...
                a(s, i), s.prototype.supportsBinary = !1, s.prototype.doClose = function () {
                    ...
                    var t = this, n = e.createElement("script");
                    ...
                    var s = this;
                    if (!this.form) {
                        var i, a = e.createElement("form"), c = e.createElement("textarea"),
            ...
            (function (n) {
                ...
                var s, i = o(26), a = o(27), c = o(36), u = o(37), h = o(38), l = o(3)("engine.io-client:websocket"),
                ...
                f || void 0 !== t || (f = s), e.exports = r, u(r, i), r.prototype.name = "websocket", r.prototype.supportsBinary = !0, r.prototype.doOpen = function () {
                    if (this.check()) {
                        var t = this.uri(), e = {agent: this.agent, perMessageDeflate: this.perMessageDeflate};
            ...
            (function (e) {
                var n = /^[\],:{}\s]*$/, o = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
            ...
            var r = n(7), s = n(35), i = n(45), a = n(46), c = n(47), u = n(3)("socket.io-client:socket"), h = n(29);
            t.exports = o;
            var l = {
                connect: 1,
                connect_error: 1,
    ...
    const N = "#56CE27", _ = "#CCCC00", O = "#3975CE", j = "#56CE27", G = "#CE4F0A", q = 500, W = 500, H = 18, F = 31,
        z = 24, J = [H, F, z], X = {
    ...
    var K = function (t, e) {
        ...
        var n = this, o = new XMLHttpRequest;
    ...
    var Z = function (t) {
        this.canvas = t, this.canvasCtx = this.canvas[0].getContext("2d"), this.canvasCtx.mozImageSmoothingEnabled = !1, this.canvasCtx.webkitImageSmoothingEnabled = !1, this.canvasCtx.msImageSmoothingEnabled = !1, this.canvasCtx.imageSmoothingEnabled = !1, this.mouseposPrev = {
            x: 0,
            y: 0
        }, this.mousepos = {x: 0, y: 0}, this.drawCommands = [], this.drawCommandsReceived = [], this.brush = new Q;
        var e = this;
    ...
    Z.prototype.updateMousePosition = function (t, e, n) {
        var o = this.canvas[0].getBoundingClientRect(), r = this.canvas[0].width, s = this.canvas[0].height,
            i = o.width, a = o.height, c = (t - o.left) / i, u = (e - o.top) / a;
        ...
        switch (t[0]) {
            case 0:
                ...
                var n = Math.floor(Math.ceil(e / 2)), o = i(Math.floor(t[3]), -n, this.canvas[0].width + n),
                    r = i(Math.floor(t[4]), -n, this.canvas[0].height + n),
                    s = i(Math.floor(t[5]), -n, this.canvas[0].width + n),
                    c = i(Math.floor(t[6]), -n, this.canvas[0].height + n), u = a(this.brush.getColor(t[1]));
                this.plotLine(o, r, s, c, e, u.r, u.g, u.b);
                break;
            case 1:
                var e = Math.floor(t[1]);
                e < this.brush.thicknessMin && (e = this.brush.thicknessMin), e > this.brush.thicknessMax && (e = this.brush.thicknessMax);
                var n = Math.floor(Math.ceil(e / 2)), o = i(Math.floor(t[2]), -n, this.canvas[0].width + n),
                ...
                break;
            case 2:
                var u = a(this.brush.getColor(t[1])), h = i(Math.floor(t[2]), 0, this.canvas[0].width),
                    l = i(Math.floor(t[3]), 0, this.canvas[0].height);
                this.floodFill(h, l, u.r, u.g, u.b)
        }
    }, Z.prototype.getImageData = function (t, e, n, o) {
        var r = Math.min(t, n), s = Math.min(e, o), i = Math.abs(t - n), a = Math.abs(e - o);
        ...
        var s = this.canvasCtx.getImageData(0, 0, this.canvas[0].width, this.canvas[0].height), i = [[t, e]],
            a = this.getPixel(s, t, e);
        if (n != a[0] || o != a[1] || r != a[2]) {
            for (var c = function (t) {
                var e = s.data[t], i = s.data[t + 1], c = s.data[t + 2];
                if (e == n && i == o && c == r) return !1;
                var u = Math.abs(e - a[0]), h = Math.abs(i - a[1]), l = Math.abs(c - a[2]);
                return u < 1 && h < 1 && l < 1
        ...
        var c = Math.floor(r / 2), u = c * c, h = Math.min(t, n) - c, l = Math.min(e, o) - c, p = Math.max(t, n) + c,
            f = Math.max(e, o) + c;
        t -= h, e -= l, n -= h, o -= l;
        var d = this.canvasCtx.getImageData(h, l, p - h, f - l), y = function (t, e) {
            for (var n = -c; n <= c; n++) for (var o = -c; o <= c; o++) if (n * n + o * o < u) {
                var r = 4 * ((e + o) * d.width + t + n);
                r >= 0 && r < d.data.length && (d.data[r] = s, d.data[r + 1] = i, d.data[r + 2] = a, d.data[r + 3] = 255)
            }
        };
        if (t == n && e == o) y(t, e); else {
            y(t, e), y(n, o);
            var m = Math.abs(n - t), g = Math.abs(o - e), v = t < n ? 1 : -1, b = e < o ? 1 : -1, w = m - g;
    ...
    Q.prototype.hide = function () {
        ...
        switch (this.tool) {
            ...
            case"erase":
                ...
                var t = this.brushCanvas.toDataURL(), e = this.thicknessMax / 2;
    ...
    tt.prototype.updatePlayerAvatars = function () {
        ...
        var r = n("#boxMessages"), s = Math.abs(r[0].scrollTop - (r[0].scrollHeight - r.height())), i = s < 10,
            a = n("<p></p>");
        if (a.css("color", o), a.appendTo(r), t) {
            n("<b/>", {text: t.name + ": "}).appendTo(a), this.playerMessage(t, e)
        } else a.css("font-weight", "bold");
        n("<span/>", {text: e}).appendTo(a), i && r.scrollTop(r[0].scrollHeight)
    }, tt.prototype.chatDisable = function () {
    }, tt.prototype.chatEnable = function () {
    };
    var et = function (t, e) {
    ...
    var ot = t.location != t.parent.location ? e.referrer : e.location.href, rt = function (t, e) {
        return -1 !== t.indexOf(e)
    };
    (rt(ot, "skribbl-io.com") || rt(ot, "skribblio.com") || rt(ot, "skribbl-io.org")) && (t.top.location.href = "https://www.skribbl.io"), n(function () {
        n('[data-toggle="tooltip"]').tooltip()
    });
    var st = null, it = null, at = new V, ct = new nt, ut = new Z(n("#canvasGame")), ht = new Array, lt = !1, pt = !1;
    ut.setDrawing(!1), ct.goto("login");
    var ft = !1;
    ct.screens.game.onshow = function () {
        ft || (ft = !0, (adsbygoogle = t.adsbygoogle || []).push({}))
        ...
        var o = e.head || e.getElementsByTagName("head")[0], r = e.createElement("script"), s = !0;
    ...
    S(80), n("#lobbySetLanguage").on("change", function () {
        ...
        var t = {name: n("#lobbyCreateName").val(), private: n("#lobbyCreatePrivate").prop("checked")};
    ...
    ut.canvas.on("touchstart", function (t) {
        ...
        t.preventDefault();
        for (var e = t.changedTouches, n = 0; n < e.length; n++) if (e[n].identitfier == gt) {
        ...
        var t = ut.brush.thicknessMin, e = ut.brush.thicknessMax, o = Number(n(this).data("size")) * (e - t) + t;
